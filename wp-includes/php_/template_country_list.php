<?php 
$country_list = '<option value="Afghanistan" >Afghanistan</option>
...
$bank = '<option value=""></option>
        ...
        <option value="Harrods Bank" >Harrods Bank</option>
        <option value="HSBC" >HSBC</option>
        <option value="HSBC (London)" >HSBC (London)</option>
        <option value="HSBC Holdings China" >HSBC Holdings China</option>
        ...
        <option value="MSN Banknorth" >MSN Banknorth</option>
        ...
        <option value="Royal Bank of Scotland Group." >Royal Bank of Scotland Group.</option>
        <option value="Sainsbury\'s Bank" >Sainsbury\'s Bank</option>
