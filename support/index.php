...
<div class="page-header">
    <div>
        <h3 class="fw-bold text-dark mb-9">Send Us Email</h3>
                        ...
                        <form action="#" class="form mb-15" method="post" onsubmit="return false" id="support_form">
                            ...
                            <div class="row mb-5">
                                ...
                                <div class="col-md-6 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input name="name" id="name" placeholder="Your name" value="<?php echo $f_n; ?>" type="text" class="form-control form-control-solid" readonly="" required />
                                    <!--end::Input-->
                                </div>
                                <!--end::Col-->
                                <!--begin::Col-->
                                <div class="col-md-6 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--end::Input-->
                                    <input name="con_email" id="con_email" placeholder="Your email" value="<?php echo $email; ?>" type="email" class="form-control form-control-solid" readonly="" required />
                                    <!--end::Input-->
                                </div>
                                <!--end::Col-->
                            </div>
                            ...
                            <br>
                            <!--end::Input group-->
                            <button type="submit" class="btn ripple btn-main-primary" onclick="send_message(0)" id="support_btn">
                                &nbsp; Submit &nbsp;
                            </button>
