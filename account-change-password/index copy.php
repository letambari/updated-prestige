    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
        ...
        <div class="card mb-5 mb-xl-10">
            <div class="card-body pt-9 pb-0">
                ...
                <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                    ...
                    <!--begin::Nav item-->
                    <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-10 py-5 active" href="../account-change-password/">Security</a>
                    </li>
                    <!--end::Nav item-->
                    <!--begin::Nav item-->
                    <li class="nav-item mt-2">
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="kt_account_settings_profile_details" class="collapse show">
                <form onsubmit="return false" id="changePass" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                    ...
                    <div class="card-body border-top p-9">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 fv-row fv-plugins-icon-container">
                                        <input placeholder="Email Address" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" type="email" value="<?php echo $email;?>"
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                <input class="form-control form-control-lg form-control-solid" id="current_password" name="current_password" 
                        ...
                        <div class="row mb-6">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                <input class="form-control form-control-lg form-control-solid" id="password2" name="password2" 
                        ...
                        <div class="row mb-6">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                <input class="form-control form-control-lg form-control-solid" name="password" id="password" 
                                    placeholder="Retype New Password" type="password" autocomplete="off" />
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                            <!--end::Col-->
                        </div>
                    ...
                    <div class="card-footer d-flex justify-content-end py-6 px-9">
                        ...
                        <button onclick="change_pass()" id="pass_btn" type="submit" class="btn btn-primary ">
                            Update Password
                        </button>
                    </div>
                    <!--end::Actions-->
