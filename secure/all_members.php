                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table table-head-bg-info  table-striped table-bordered"   cellspacing="0">
                                                    ...
                                                    <tbody>';
                $sql = "SELECT id,username,unique_field,full_name,email,user_type,phone,country,sponsor,active,signup FROM users ";
                $query = mysqli_query($db_conx, $sql);
                ...
                if($numrows > 0){                    
                    ...
                    while ($row = mysqli_fetch_array($query, MYSQLI_ASSOC)) {
                        ...
                        if($user_type ==='admin'){
                            ...
                            if($user_type_two ==='admin'){
                                $user_admin_btn='<button class="btn btn-danger mb-1 btn-sm" id="'."$uname$count".'_swap" '
                        ...
                        $display .='<tr>
                            ...
                            <td>
                                ...
                                <a href="member_dashboard.php?user='.$unique1.'" target="_blanc" class="btn btn-primary mb-1 btn-sm">View Dashboard</a>
                            </td>
                        </tr>';
