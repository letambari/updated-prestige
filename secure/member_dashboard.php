                            ...
                            <div id="kt_app_content" class="app-content flex-column-fluid">
                                ...
                                <div id="kt_app_content_container" class="app-container container-fluid">
                                    ...
                                    <div class="row g-5 g-xl-8">
                                        <div class="col-xl-3">
                                            ...
                                            <a href="javascript:void(0)" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="fw-semibold text-gray-400">Invested</div>
                                                </div>
                                                <!--end::Body-->
                                            </a>
                                            <!--end::Statistics Widget 5-->
                                        ...
                                        <div class="col-xl-3">
                                            ...
                                            <a href="javascript:void(0)" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <!--end::Svg Icon-->
                                                    <div class="text-gray-100 fw-bold fs-2 mb-2 mt-5"><?php echo $symbol.number_format($t_profit,2);?></div>
                                                    <div class="fw-semibold text-gray-100">Profit</div>
                                                </div>
                                                <!--end::Body-->
                                            </a>
                                            <!--end::Statistics Widget 5-->
                                        ...
                                        <div class="col-xl-3">
                                            ...
                                            <a href="javascript:void(0)" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <!--end::Svg Icon-->
                                                    <div class="text-white fw-bold fs-2 mb-2 mt-5"><?php echo $symbol.number_format($t_withdraw,2);?></div>
                                                    <div class="fw-semibold text-white">Withdrawal</div>
                                                </div>
                                                <!--end::Body-->
                                            </a>
                                            <!--end::Statistics Widget 5-->
                                        ...
                                        <div class="col-xl-3">
                                            <!--begin::Statistics Widget 5-->
                                            <a href="javascript:void(0)" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
                                                <!--begin::Body-->
                                                <div class="card-body">
                                                    ...
                                                    <!--end::Svg Icon-->
                                                    <div class="text-white fw-bold fs-2 mb-2 mt-5"><?php echo $symbol.number_format($t_balance,2);?></div>
                                                    <div class="fw-semibold text-white">Balance</div>
                                                </div>
                                                <!--end::Body-->
                                            </a>
                                            <!--end::Statistics Widget 5-->
                                    ...
                                    <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
                                        ...
                                        <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
                                            ...
                                            <div
                                                ...
                                                style="background-color: #f1416c; background-image: url('../assets_inside/img/vector-1.png');"
                                            >
                                                <!--begin::Header-->
                                                <div class="card-header pt-5">
                                                    ...
                                                    <div class="card-title d-flex flex-column">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <span class=" fw-bold text-white me-2 lh-1 ls-n2" style="font-size: 2rem !important;">
                                                                <?php echo number_format($total_bal,2);?>
                                                            </span>
                                                            
                                                        </div>
                                                        <!--begin::Subtitle-->
                                                        <span class="text-white opacity-75 pt-1 fw-semibold fs-6">Wallet Balance</span>
                                                        <!--end::Subtitle-->
                                                    </div>
                                                    <!--end::Title-->
                                                </div>
                                                ...
                                                <div class="card-body d-flex align-items-end pt-0">
                                                    ...
                                                    <div class="d-flex align-items-center flex-column mt-3 w-100">
                                                        <div class="d-flex justify-content-between fw-bold fs-6 text-white opacity-75 w-100 mt-auto mb-2">
                                                            <span><?php echo $trans_count;?> transactions</span>
                                                            <span></span>
                                                        </div>
                                                ...
                                                <div class="card-header pt-5">
                                                    ...
                                                    <div class="card-title d-flex flex-column">
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <!--end::Currency-->
                                                            <!--begin::Amount-->
                                                            <span class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2"><?php echo $investment_count;?></span>
                                                            <!--end::Amount-->
                                                            
                                                        </div>
                                                        <!--end::Info-->
                                                        <!--begin::Subtitle-->
                                                        <span class="text-gray-400 pt-1 fw-semibold fs-6">Invested Portfolio</span>
                                                        <!--end::Subtitle-->
                                                    </div>
                                                    <!--end::Title-->
                                                </div>
                                                ...
                                                <div class="card-body pt-2 pb-4 d-flex flex-wrap align-items-center">
                                                    ...
                                                    <div class="d-flex flex-column content-justify-center flex-row-fluid">
                                                        ...
                                                        <div class="d-flex fw-semibold align-items-center">
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Stats-->
                                                            <div class="fw-bolder text-gray-700 text-xxl-end"><?php echo $cap;?></div>
                                                            <!--end::Stats-->
                                                        </div>
                                                        <!--end::Label-->
                                                        <!--begin::Label-->
                                                        <div class="d-flex fw-semibold align-items-center my-3">
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Stats-->
                                                            <div class="fw-bolder text-gray-700 text-xxl-end"><?php echo $psp;?></div>
                                                            <!--end::Stats-->
                                                        </div>
                                                        <!--end::Label-->
                                                        <!--begin::Label-->
                                                        <div class="d-flex fw-semibold align-items-center">
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Stats-->
                                                            <div class="fw-bolder text-gray-700 text-xxl-end"><?php echo $pcpp;?></div>
                                                            <!--end::Stats-->
                                                        </div>
                                                        <!--end::Label-->
                                                    </div>
                                            ...
                                            <div class="card card-flush h-md-100">
                                                ...
                                                <div class="card-header pt-7">
                                                    ...
                                                    <h3 class="card-title align-items-start flex-column">
                                                        <span class="card-label fw-bold text-gray-800">Active Investment Portfolios</span>
                                                        <span class="text-gray-400 mt-1 fw-semibold fs-6">Last 5 records</span>
                                                    </h3>
                                                    <!--end::Title-->
                                                    <!--begin::Toolbar-->
                                                    <div class="card-toolbar">
                                                        <a href="../my-investments/" class="btn btn-sm btn-light">See all</a>
                                                    </div>
                                                    <!--end::Toolbar-->
                                                </div>
                                                <!--end::Header-->
                                                        ...
                                                        <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                                                            ...
                                                            <thead>
                                                                <tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
                                                                    <th class="pb-3 ">#</th>
                                                                    <th class=" pb-3 ">Portfolio</th>
                                                                    <th class=" pb-3 ">Invested</th>
                                                                    <th class=" pb-3 ">Profit</th>
                                                                    <th class=" pb-3 ">Withdrawal</th>
                                                                    <th class=" pb-3 ">View</th>
                                                                </tr>
                                                            </thead>
                                                            <!--end::Table head-->
                                                            <!--begin::Table body-->
                                        ...
                                        <div class="col-xxl-12 mb-xl-12">
                                            ...
                                            <div class="card card-flush h-xl-100">
                                                ...
                                                <div class="card-header pt-5">
                                                    <!--begin::Title-->
                                                    <h3 class="card-title align-items-start flex-column">
                                                        <span class="card-label fw-bold text-dark">Transaction History</span>
                                                        <span class="text-gray-400 mt-1 fw-semibold fs-6">Last 5 records</span>
                                                    </h3>
                                                    <!--end::Title-->
                                                    <!--begin::Toolbar-->
