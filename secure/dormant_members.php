	...
	$display = '';
                                ...
                                <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table table-head-bg-info  table-striped table-bordered"   width="100%" cellspacing="0">
                                                    <thead >
                                                        <tr >
                                                            <th width="8%">S/n</th>
                                                            <th>Details</th>   
                ...
                if($numrows > 0){                    
                    ...
                    while ($row = mysqli_fetch_array($query, MYSQLI_ASSOC)) {
                        ...
                        $user_admin_btn='';
                        if($user_type ==='admin'){
                            $user_admin_btn='<button class="btn btn-primary btn-sm mb-1" id="'."$uname$count".'_swap" '
...
<?php 
/////////////////////////////////////////////
    $title ='Domant Members | '.$site_name;
    $title2 ='Domant Members';
    $keyword ='';
    $discription = ''; 
    $dash = '';
    $dep = '';
