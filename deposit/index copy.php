                                    ...
                                    <div class="card-body pt-5">
                                        <div class="stepper stepper-links d-flex flex-column gap-5" id="kt_modal_top_up_wallet_stepper" data-kt-stepper="true">
                                            ...
                                            <form class="mx-auto w-100 mw-600px pt-15 pb-10 fv-plugins-bootstrap5 fv-plugins-framework" 
                                                novalidate="novalidate" onsubmit="return false;" method="POST" id="deposite_form" autocomplete="off">
                                                <!--begin::Step 1-->
...
//                                                                            $display .='<option value="'.$wallet_name.'">'.strtoupper($wallet_symbol).'</option>';
                                                        ...
                                                        <div class=" fv-row fv-plugins-icon-container text-right" style=" margin-top: 50px;">
                                                            ...
                                                            <button type="button" class="btn btn-lg btn-primary" onclick="deposit_funds('two','three');"
                                                                    style="float: right" id="funds_btn">
                                                                Continue &nbsp;
                                                                <span class="svg-icon svg-icon-3 ms-1 me-0">
                                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        <rect opacity="0.5" x="18" y="13" width="13" height="2" rx="1" transform="rotate(-180 18 13)" fill="currentColor"></rect>
                                                ...
                                                <div data-kt-stepper-element="content" id="dep_step_three">
                                                    ...
                                                    <div class="w-100">
                                                                    ...
                                                                    <div class="col-sm-10 text-center">
                                                                        ...
                                                                        <div class="input-group" style=" ">
                                                                            ...
                                                                            <div class="input-group-append">
                                                                                <button type="button" onclick="copy_text('coin_address')" data-clipboard-target="#coin_address" 
                                                                                        class="btn btn-primary clipboard-trigger" id="coin_address_btn" title="Copy wallet address">
                                                        ...
                                                        <div class=" fv-row fv-plugins-icon-container text-right" style=" margin-top: 50px;">
                                                            ...
                                                            <button type="button" class="btn btn-lg btn-primary" onclick="deposit_step_one('three','four');"
                                                                    style="float: right">
                                                                Confirm Payment
                                                                <!--begin::Svg Icon | path: icons/duotune/arrows/arr064.svg-->
                                                                <span class="svg-icon svg-icon-3 ms-1 me-0">
