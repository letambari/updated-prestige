...
//    $FullName = mysqli_real_escape_string($db_conx, $_POST['FullName']);
    $username = mysqli_real_escape_string($db_conx, $_POST['name']);
...
//     $hash = $kaboom[1];
        ...
        $sql = "INSERT INTO users (full_name,password, email,sponsor,signup)";
            ...
            <div class="row row-sm">
                <div class="col-lg-6 col-xl-5 d-none d-lg-block text-center bg-primary details">
                    <div class="mt-5 pt-4 p-2 pos-absolute">
                        ...
                        <h5 class="mt-4 text-white" style="padding-left: 40px">Create Your Account</h5>
                    ...
                    <div class="container-fluid">
                        <div class="row row-sm">
                            ...
                            <form class="form w-100" novalidate="novalidate" name="register-form" id="register-form" onsubmit="return false;">
                                ...
                                <!--begin::Input group-->
                                <div  class="form-group text-left" data-kt-password-meter="true">
                                    <!--begin::Wrapper-->
                                    <div class="mb-0">
                                    <label>Password</label>
                                        ...
                                        <!--end::Input wrapper-->
                                        <!--begin::Meter-->
                                        <div class="form-group text-left" data-kt-password-meter-control="highlight">
                                ...
                                <!--end::Input group=-->
                                <!--end::Accept-->
                                <div class="form-group text-left mb-3 mt-3">
                                    <div id="msg1" style=" width: 100%"></div>
                                </div>
                                <!--begin::Submit button-->
                                <div class="form-group text-left">
                                    <button type="submit"  class="btn ripple btn-main-primary btn-block" name="btn-register" id="btn-register">
                                        Sign Up
                                    </button>
                                </div>
                                <!--end::Submit button-->
