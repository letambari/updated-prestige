...
$login = '<!--begin::Form-->
            <form class="form w-100" novalidate="novalidate"  name="loginform" id="loginform" onsubmit="return false;">
                ...
                <div class="d-grid mb-10">
                    <button type="submit" name="btn_login"  id="btn-login" onclick="//Login()" class="btn btn-primary">
                        Sign In 
                    </button>
                </div>
                <!--end::Submit button-->
...
if(isset($_GET['security-clearance']) && ''!=$_GET['security-clearance'] && isset($_SESSION["security_level"])
    ...
    $login = '<!--begin::Form-->
                <form class="form w-100" novalidate="novalidate"  name="loginform" id="loginform" onsubmit="return false;">
                    ...
                    <!--begin::Submit button-->
                    <div class="d-grid mb-10">
                        <button type="submit" name="btn_login2"  id="btn-login2" onclick="//Login2()" class="btn  btn-primary">
                            Approve Login 
                        </button>
                    </div>
                    <!--end::Submit button-->
