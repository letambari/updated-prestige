...
<div class="custom-card" style="background-color: white">
    <div class="card-body pt-5">
        <div class="stepper stepper-links d-flex flex-column gap-5" id="kt_modal_top_up_wallet_stepper" data-kt-stepper="true">
            ...
            <!--end::Nav-->
            <!--begin::Form-->
            <form class="mx-auto w-100 mw-600px pt-15 pb-10 fv-plugins-bootstrap5 fv-plugins-framework" novalidate="novalidate" onsubmit="return false;" method="POST" id="withdraw_form" autocomplete="off">
                <!--begin::Step 1-->
                <div class="current" data-kt-stepper-element="content" id="with_step_one">
                    ...
                    <div class="w-100">
                        ...
                        <div class="mb-10 fv-row fv-plugins-icon-container">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" class="form-control form-control-lg form-control-solid" required="" name="amount" id="amount" placeholder="Amount (to the nearest dollar)" autocomplete="off" />
                            <input type="hidden" class="form-control " name="with_amount" id="with_amount" value="" />
                            <input type="hidden" class="form-control " name="plan_id" id="plan_id" value="" />
                            <!--end::Input-->
                            <div class="fv-plugins-message-container invalid-feedback"></div>
                        </div>
                        <!--end::Input group-->
                ...
                <div data-kt-stepper-element="content" id="with_step_two">
                    ...
                    <div class="w-100">
                        ...
                        <div class=" fv-row fv-plugins-icon-container text-right" style=" margin-top: 50px;">
                            ...
                            <button type="button" class="btn btn-lg btn-primary" onclick="withdrawal_step_one('two','three');" style="float: right">
                                Continue &nbsp;
                                <span class="svg-icon svg-icon-3 ms-1 me-0">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect opacity="0.5" x="18" y="13" width="13" height="2" rx="1" transform="rotate(-180 18 13)" fill="currentColor"></rect>
                ...
                <div data-kt-stepper-element="content" id="with_step_three">
                    ...
                    <div class="w-100">
                        ...
                        <div class="mb-10 fv-row fv-plugins-icon-container">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" class="form-control form-control-lg form-control-solid" required="" name="withdraw_details" id="withdraw_details" placeholder="Enter receiving address" autocomplete="off" />
                            <div class="fv-plugins-message-container invalid-feedback"></div>
                        </div>
                        <div class="mb-10 fv-row fv-plugins-icon-container">
                            <!--end::Input-->
                        ...
                        <div class=" fv-row fv-plugins-icon-container text-right" style=" margin-top: 50px;">
                            ...
                            <button type="submit" class="btn btn-lg btn-primary" onclick="withdraw_funds('three','four');" style="float: right" id="withdraw_btn">
                                Submit
                                <!--begin::Svg Icon | path: icons/duotune/arrows/arr064.svg-->
                                <span class="svg-icon svg-icon-3 ms-1 me-0">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="row row-sm">
    <div class="col-lg-12">
        <div class="card custom-card overflow-hidden">
            <div class="card-body">
                <div>
                    <h6 class="main-content-label mb-1">Withdrawal History</h6>
                </div>
