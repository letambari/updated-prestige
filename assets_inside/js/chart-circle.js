        ...
        !(function (t, n) {
                                    ...
                                    var n = t.length > 0,
                                        ...
                                        o = function (o, a, s, u, c) {
                                            ...
                                            if (((m += y), n && y !== m)) {
                                                ...
                                                P.apply(u, b), c && !o && b.length > 0 && m + t.length > 1 && se.uniqueSort(u);
                                            }
                                            return c && ((T = S), (l = w)), x;
                                        };
                                    return n ? le(o) : o;
                        ...
                        var t = [
                            ...
                            i = {
                                ...
                                then: function (e, r, i) {
                                                        ...
                                                        (l = n && ("object" == typeof n || "function" == typeof n) && n.then),
                                                            m(l)
                                                                ? i
                                                                    ...
                                                                    : (o++, l.call(n, a(o, t, I, i), a(o, t, F, i), a(o, t, I, t.notifyWith)))
                                                ...
                                                c = i
                                                    ...
                                                    : function () {
                                                          try {
                                                              ...
                                                              C.Deferred.exceptionHook && C.Deferred.exceptionHook(n, c.stackTrace), e + 1 >= o && (r !== F && ((s = void 0), (u = [n])), t.rejectWith(s, u));
                                                          }
                                                      };
                                    ...
                                    return C.Deferred(function (n) {
                                        t[0][3].add(a(0, n, m(i) ? i : I, n.notifyWith)), t[1][3].add(a(0, n, m(e) ? e : I)), t[2][3].add(a(0, n, m(r) ? r : F));
                                    }).promise();
                                },
                                promise: function (e) {
            ...
            function Te(e, t, n, r, i) {
                ...
                for (f.textContent = "", d = 0; (o = p[d++]); )
                    ...
                    else if (((l = ae(o)), (a = xe(f.appendChild(o), "script")), l && be(a), n)) for (c = 0; (o = a[c++]); ) me.test(o.type || "") && n.push(o);
                return f;
            }
            var Ce = /^key/,
                        ...
                        for (c = a[a.length - 1].ownerDocument, C.map(a, Me), f = 0; f < s; f++)
                            (l = a[f]),
                                me.test(l.type || "") &&
                                    ...
                                    C.contains(c, l) &&
                                    (l.src && "module" !== (l.type || "").toLowerCase() ? C._evalUrl && !l.noModule && C._evalUrl(l.src, { nonce: l.nonce || l.getAttribute("nonce") }, c) : w(l.textContent.replace(Pe, ""), l, c));
                }
                return e;
            }
            function We(e, t, n) {
            ...
            C.extend({
                ...
                clone: function (e, t, n) {
                    ...
                    if (t)
                        if (n) for (o = o || xe(e), a = a || xe(s), r = 0, i = o.length; r < i; r++) Re(o[r], a[r]);
                        else Re(e, s);
            ...
            function Ve(e, t, n) {
                ...
                return (
                    (n = n || $e(e)) &&
                        ...
                        !v.pixelBoxStyles() && Be.test(a) && ze.test(t) && ((r = s.width), (i = s.minWidth), (o = s.maxWidth), (s.minWidth = s.maxWidth = s.width = a), (a = n.width), (s.width = r), (s.minWidth = i), (s.maxWidth = o))),
                    void 0 !== a ? a + "" : a
                );
            }
            function Ue(e, t) {
            ...
            (C.Animation = C.extend(dt, {
                ...
                (C.speed = function (e, t, n) {
                    var r = e && "object" == typeof e ? C.extend({}, e) : { complete: n || (!n && t) || (m(e) && e), duration: e, easing: (n && t) || (t && !m(t) && t) };
                    return (
            ...
            (Bt.href = St.href),
                C.extend({
                    ...
                    ajax: function (e, t) {
                        ...
                        if ((d.data && d.processData && "string" != typeof d.data && (d.data = C.param(d.data, d.traditional)), _t(It, d, t, S), l)) return S;
                        ...
                        d.hasContent
                            ...
                            : ((p = d.url.slice(i.length)),
                              ...
                              !1 === d.cache && ((i = i.replace(Ot, "$1")), (p = (kt.test(i) ? "&" : "?") + "_=" + Et.guid++ + p)),
                              (d.url = i + p)),
                        d.ifModified && (C.lastModified[i] && S.setRequestHeader("If-Modified-Since", C.lastModified[i]), C.etag[i] && S.setRequestHeader("If-None-Match", C.etag[i])),
                        ...
                        if (((T = "abort"), m.add(d.complete), S.done(d.success), S.fail(d.error), (r = _t(Ft, d, t, S)))) {
                        ...
                        function E(e, t, a, u) {
                            ...
                            l ||
                                ...
                                f
                                    ? (d.ifModified && ((w = S.getResponseHeader("Last-Modified")) && (C.lastModified[i] = w), (w = S.getResponseHeader("etag")) && (C.etag[i] = w)),
                                ...
                                S.statusCode(y),
                                (y = void 0),
                                c && g.trigger(f ? "ajaxSuccess" : "ajaxError", [S, d, f ? p : x]),
                                m.fireWith(h, [S, T]),
                                c && (g.trigger("ajaxComplete", [S, d]), --C.active || C.event.trigger("ajaxStop")));
                        }
                        return S;
                    },
                ...
                C.each(["get", "post"], function (e, t) {
                    C[t] = function (e, n, r, i) {
                        return m(n) && ((i = i || r), (r = n), (n = void 0)), C.ajax(C.extend({ url: e, type: t, dataType: i, data: n, success: r }, C.isPlainObject(e) && e));
                    };
                }),
    ...
    29: function (e, t, n) {
        !(function (e) {
            ...
            var t,
                ...
                i,
                o = n(1)(".forth.circle");
                var value = $(".forth.circle").data("value");
            o.circleProgress(
                ((t = { startAngle: (-Math.PI / 2) * 9, value: 0.5, lineCap: "round", emptyFill: "rgba(204, 204, 204,0.2)", fill: { color: "#6259ca" } }),
                (i = "round"),
                (r = "lineCap") in t ? Object.defineProperty(t, r, { value: i, enumerable: !0, configurable: !0, writable: !0 }) : (t[r] = i),
                t)
            ),
                setTimeout(function () {
                    ...
                    typeof (r = function (e) {
                        ...
                        (t.prototype = {
                            ...
                            initFill: function () {
                                    ...
                                    if (1 == a.length) this.arcFill = a[0];
                                        ...
                                        for (
                                            var s = r.gradientAngle || 0,
                                                u = r.gradientDirection || [(o / 2) * (1 - Math.cos(s)), (o / 2) * (1 + Math.sin(s)), (o / 2) * (1 + Math.cos(s)), (o / 2) * (1 - Math.sin(s))],
                                            ...
                                            var f = a[c],
                                                p = c / (a.length - 1);
                                            e.isArray(f) && ((p = f[1]), (f = f[0])), l.addColorStop(p, f);
                                        }
                                        this.arcFill = l;
                                    }
                                }
                                function d() {
                                    var r = e("<canvas>")[0];
                                    (r.width = n.size), (r.height = n.size), r.getContext("2d").drawImage(t, 0, 0, o, o), (n.arcFill = n.ctx.createPattern(r, "no-repeat")), n.drawFrame(n.lastFrameValue);
                                }
                                r.image && (r.image instanceof Image ? (t = r.image) : ((t = new Image()).src = r.image), t.complete ? d() : (t.onload = d));
                            },
                            draw: function () {
                                        ...
                                        .animate(
                                            ...
                                            e.extend({}, this.animation, {
                                                step: function (e) {
                                                    ...
                                                    n.drawFrame(i), r.trigger("circle-animation-progress", [e, i]);
                                                },
                                            })
                                        )
                                        .promise()
                            ...
                            (e.easing.circleProgressEasing = function (e) {
                                return e < 0.5 ? 0.5 * (e *= 2) * e * e : 1 - 0.5 * (e = 2 - 2 * e) * e * e;
                            }),
                            (e.fn.circleProgress = function (n, r) {
                                ...
                                return this.each(function () {
                                    ...
                                    if (o) o.init(a);
                                        ...
                                        "string" == typeof s.fill && (s.fill = JSON.parse(s.fill)), "string" == typeof s.animation && (s.animation = JSON.parse(s.animation)), ((a = e.extend(s, a)).el = r), (o = new t(a)), r.data(i, o);
                                    }
                                });
                            });
                    })
